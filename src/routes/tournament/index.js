...
router.get('/get', allow('authenticated'), new GetUserTournamentsRoute(tournamentRepository).route)
router.get('/get/all', new GetAllTournamentsRoute(tournamentRepository).route)
router.get('/get/judge', new GetJudgeTournamentRoute(tournamentRepository).route)
router.get(
  '/get/:tournamentId',
