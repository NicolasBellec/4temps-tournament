...
router.post(
  ...
  allow('admin'),
  new EndDanceRoute(tournamentRepository, noteRepository, pushLeaderboardUpdate).route()
)
...
router.post('/:tournamentId/settle-draw', new SettleDrawRoute(tournamentRepository).route)
