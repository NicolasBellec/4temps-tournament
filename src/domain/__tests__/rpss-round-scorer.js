...
describe('RPSS Round scorer', () => {
  ...
  const judgesWithSanctionner: Judge[] = [
    ...judges,
    judgeSanction
  ];
  const dances = [
  ...
  const criteriaWithPenalty: RoundCriterion[] = [
    ...criteria,
    penaltyCriterion
  ];
  ...
  const fullScaleScores: Array < JudgeNote > = [
    // Dance 0, leader 0
    ...genFullDanceJudgeNote(judges[0], leaders[0], dances[0], criteria, [0, 0, 0]),
    ...genFullDanceJudgeNote(judges[1], leaders[0], dances[0], criteria, [1, 0, 0]),
    ...genFullDanceJudgeNote(judges[2], leaders[0], dances[0], criteria, [2, 0, 0]),
    ...genFullDanceJudgeNote(judges[3], leaders[0], dances[0], criteria, [3, 0, 0]),
    genJudgeNote(judgeSanction, leaders[0], dances[0], penaltyCriterion, 0),
    // Dance 1, leader 0
    ...genFullDanceJudgeNote(judges[0], leaders[0], dances[1], criteria, [2, 0, 0]),
    ...genFullDanceJudgeNote(judges[1], leaders[0], dances[1], criteria, [3, 0, 0]),
    ...genFullDanceJudgeNote(judges[2], leaders[0], dances[1], criteria, [4, 0, 0]),
    ...genFullDanceJudgeNote(judges[3], leaders[0], dances[1], criteria, [5, 0, 0]),
    genJudgeNote(judgeSanction, leaders[0], dances[1], penaltyCriterion, 2),
    // Dance 0, leader 1
    ...genFullDanceJudgeNote(judges[0], leaders[1], dances[0], criteria, [4, 0, 0]),
    ...genFullDanceJudgeNote(judges[1], leaders[1], dances[0], criteria, [5, 0, 0]),
    ...genFullDanceJudgeNote(judges[2], leaders[1], dances[0], criteria, [6, 0, 0]),
    ...genFullDanceJudgeNote(judges[3], leaders[1], dances[0], criteria, [7, 0, 0]),
    genJudgeNote(judgeSanction, leaders[1], dances[0], penaltyCriterion, 1),
    // Dance 1, leader 1
    ...genFullDanceJudgeNote(judges[0], leaders[1], dances[1], criteria, [6, 0, 0]),
    ...genFullDanceJudgeNote(judges[1], leaders[1], dances[1], criteria, [7, 0, 0]),
    ...genFullDanceJudgeNote(judges[2], leaders[1], dances[1], criteria, [8, 0, 0]),
    ...genFullDanceJudgeNote(judges[3], leaders[1], dances[1], criteria, [9, 0, 0]),
    genJudgeNote(judgeSanction, leaders[1], dances[1], penaltyCriterion, 3),
    // Dance 2, leader 2
    ...genFullDanceJudgeNote(judges[0], leaders[2], dances[2], criteria, [8, 0, 0]),
    ...genFullDanceJudgeNote(judges[1], leaders[2], dances[2], criteria, [9, 0, 0]),
    ...genFullDanceJudgeNote(judges[2], leaders[2], dances[2], criteria, [10, 0, 0]),
    ...genFullDanceJudgeNote(judges[3], leaders[2], dances[2], criteria, [10, 1, 0]),
    genJudgeNote(judgeSanction, leaders[2], dances[2], penaltyCriterion, 2),
    // Dance 3, leader 2
    ...genFullDanceJudgeNote(judges[0], leaders[2], dances[3], criteria, [10, 0, 0]),
    ...genFullDanceJudgeNote(judges[1], leaders[2], dances[3], criteria, [10, 1, 0]),
    ...genFullDanceJudgeNote(judges[2], leaders[2], dances[3], criteria, [10, 2, 0]),
    ...genFullDanceJudgeNote(judges[3], leaders[2], dances[3], criteria, [10, 3, 0]),
    genJudgeNote(judgeSanction, leaders[2], dances[3], penaltyCriterion, 4),
    // Dance 2, leader 3
    ...genFullDanceJudgeNote(judges[0], leaders[3], dances[2], criteria, [10, 2, 0]),
    ...genFullDanceJudgeNote(judges[1], leaders[3], dances[2], criteria, [10, 3, 0]),
    ...genFullDanceJudgeNote(judges[2], leaders[3], dances[2], criteria, [10, 4, 0]),
    ...genFullDanceJudgeNote(judges[3], leaders[3], dances[2], criteria, [10, 5, 0]),
    genJudgeNote(judgeSanction, leaders[3], dances[2], penaltyCriterion, 3),
    // Dance 3, leader 3
    ...genFullDanceJudgeNote(judges[0], leaders[3], dances[3], criteria, [10, 4, 0]),
    ...genFullDanceJudgeNote(judges[1], leaders[3], dances[3], criteria, [10, 5, 0]),
    ...genFullDanceJudgeNote(judges[2], leaders[3], dances[3], criteria, [10, 6, 0]),
    ...genFullDanceJudgeNote(judges[3], leaders[3], dances[3], criteria, [10, 7, 0]),
    genJudgeNote(judgeSanction, leaders[3], dances[3], penaltyCriterion, 5),
    // Dance 0, follower 0
    ...genFullDanceJudgeNote(judges[0], followers[0], dances[0], criteria, [10, 6, 0]),
    ...genFullDanceJudgeNote(judges[1], followers[0], dances[0], criteria, [10, 7, 0]),
    ...genFullDanceJudgeNote(judges[2], followers[0], dances[0], criteria, [10, 8, 0]),
    ...genFullDanceJudgeNote(judges[3], followers[0], dances[0], criteria, [10, 9, 0]),
    genJudgeNote(judgeSanction, followers[0], dances[0], penaltyCriterion, 4),
    // Dance 1, follower 0
    ...genFullDanceJudgeNote(judges[0], followers[0], dances[1], criteria, [10, 8, 0]),
    ...genFullDanceJudgeNote(judges[1], followers[0], dances[1], criteria, [10, 9, 0]),
    ...genFullDanceJudgeNote(judges[2], followers[0], dances[1], criteria, [10, 10, 0]),
    ...genFullDanceJudgeNote(judges[3], followers[0], dances[1], criteria, [10, 11, 0]),
    genJudgeNote(judgeSanction, followers[0], dances[1], penaltyCriterion, 6),
    // Dance 0, follower 1
    ...genFullDanceJudgeNote(judges[0], followers[1], dances[0], criteria, [10, 10, 0]),
    ...genFullDanceJudgeNote(judges[1], followers[1], dances[0], criteria, [10, 11, 0]),
    ...genFullDanceJudgeNote(judges[2], followers[1], dances[0], criteria, [10, 12, 0]),
    ...genFullDanceJudgeNote(judges[3], followers[1], dances[0], criteria, [10, 13, 0]),
    genJudgeNote(judgeSanction, followers[1], dances[0], penaltyCriterion, 5),
    // Dance 1, follower 1
    ...genFullDanceJudgeNote(judges[0], followers[1], dances[1], criteria, [10, 12, 0]),
    ...genFullDanceJudgeNote(judges[1], followers[1], dances[1], criteria, [10, 13, 0]),
    ...genFullDanceJudgeNote(judges[2], followers[1], dances[1], criteria, [10, 14, 0]),
    ...genFullDanceJudgeNote(judges[3], followers[1], dances[1], criteria, [10, 15, 0]),
    genJudgeNote(judgeSanction, followers[1], dances[1], penaltyCriterion, 7),
    // Dance 2, follower 2
    ...genFullDanceJudgeNote(judges[0], followers[2], dances[2], criteria, [10, 14, 0]),
    ...genFullDanceJudgeNote(judges[1], followers[2], dances[2], criteria, [10, 15, 0]),
    ...genFullDanceJudgeNote(judges[2], followers[2], dances[2], criteria, [10, 16, 0]),
    ...genFullDanceJudgeNote(judges[3], followers[2], dances[2], criteria, [10, 17, 0]),
    genJudgeNote(judgeSanction, followers[2], dances[2], penaltyCriterion, 6),
    // Dance 3, follower 2
    ...genFullDanceJudgeNote(judges[0], followers[2], dances[3], criteria, [10, 16, 0]),
    ...genFullDanceJudgeNote(judges[1], followers[2], dances[3], criteria, [10, 17, 0]),
    ...genFullDanceJudgeNote(judges[2], followers[2], dances[3], criteria, [10, 18, 0]),
    ...genFullDanceJudgeNote(judges[3], followers[2], dances[3], criteria, [10, 19, 0]),
    genJudgeNote(judgeSanction, followers[2], dances[3], penaltyCriterion, 8),
    // Dance 2, follower 3
    ...genFullDanceJudgeNote(judges[0], followers[3], dances[2], criteria, [10, 18, 0]),
    ...genFullDanceJudgeNote(judges[1], followers[3], dances[2], criteria, [10, 19, 0]),
    ...genFullDanceJudgeNote(judges[2], followers[3], dances[2], criteria, [10, 19, 1]),
    ...genFullDanceJudgeNote(judges[3], followers[3], dances[2], criteria, [10, 19, 2]),
    genJudgeNote(judgeSanction, followers[3], dances[2], penaltyCriterion, 7),
    // Dance 3, follower 3
    ...genFullDanceJudgeNote(judges[0], followers[3], dances[3], criteria, [10, 19, 1]),
    ...genFullDanceJudgeNote(judges[1], followers[3], dances[3], criteria, [10, 19, 2]),
    ...genFullDanceJudgeNote(judges[2], followers[3], dances[3], criteria, [10, 19, 3]),
    ...genFullDanceJudgeNote(judges[3], followers[3], dances[3], criteria, [10, 19, 4]),
  ...
  const round2_2_2: Round = {
    ...
    groups: [{
      ...
      },
      {
        ...
        dances: [
          genDance(dances[2].id),
          genDance(dances[3].id)
        ]
      }
    ]
  };
  ...
  test('[INTERNAL] _getDances', () => {
    ...
    expect(result).toEqual(
      expect.arrayContaining(dances)
    );
    expect(result.length).toEqual(dances.length);
  }); // [INTERNAL] _getDances
  ...
  test('[INTERNAL] _getRoleParticipant', () => {
    const scorer = new RPSSRoundScorer(judges, round2_2_2);
    const resultFollower: Array < string > = scorer._getRoleParticipant('follower');
    ...
    expect(resultFollower).toEqual(
      expect.arrayContaining(expectedFollower)
    );
    expect(resultFollower.length).toEqual(expectedFollower.length);
    expect(resultLeader).toEqual(
      expect.arrayContaining(expectedLeader)
    );
    expect(resultLeader.length).toEqual(expectedLeader.length);
  ...
  test('[INTERNAL] _isPositiveJudgeType', () => {
    ...
    expect(scorerWithoutPresident._isPositiveJudgeType('president')).toBeFalsy();
    expect(scorerWithoutPresident._isPositiveJudgeType('sanctioner')).toBeFalsy();
  ...
  test('[INTERNAL] _aggregateDanceNotes : Simple', () => {
    ...
    const scores: Array < JudgeNote > = [
      ...genFullDanceJudgeNote(judges[0], leaders[0], dances[0], criteria, [2, 6, 4]),
      ...genFullDanceJudgeNote(judges[1], leaders[0], dances[0], criteria, [5, 1, 3]),
      ...genFullDanceJudgeNote(judges[2], leaders[0], dances[0], criteria, [7, 1, 1]),
      ...genFullDanceJudgeNote(judges[3], leaders[0], dances[0], criteria, [3, 4, 6]),
    ];
  ...
  test('[INTERNAL] _aggregateDanceNotes : Stripped', () => {
    ...
    const scores: Array < JudgeNote > = [
      ...
      ...genFullDanceJudgeNote(judges[0], leaders[1], dances[0], criteria, [5, 4, 9]),
      ...genFullDanceJudgeNote(judges[0], leaders[0], dances[1], criteria, [5, 7, 2]),
    ];
  ...
  test('[INTERNAL] _aggregateDanceNotes : Float', () => {
    ...
    const scores: Array < JudgeNote > = [
      ...genFullDanceJudgeNote(judges[0], leaders[0], dances[0], criteria, [5, 0, 0]),
      ...genFullDanceJudgeNote(judges[1], leaders[0], dances[0], criteria, [7, 0, 0]),
  ...
  test('[INTERNAL] _genRanksFromWeightedScores : No equality', () => {
    ...
    const result: Array < JudgeRank > = scorer._genRanksFromWeightedScores(
      scores
    );
  ...
  test('[INTERNAL] _genJudgeRanks', () => {
    ...
    const result: Array < JudgeRank > = scorer._genJudgeRanks(
      fullScaleScores
    );
  ...
  test('[INTERNAL] _genRankMatrixRow', () => {
    ...
    const expected: RankMatrixRow =
      genRow(leaders[0], judgeRanks, [0, 1, 3, 4], 2, [0, 2, 8, 12]);
  ...
  test('[INTERNAL] _genRankMatrix: leaders', () => {
    ...
    const judgeRanks: Array < JudgeRank > = scorer._genJudgeRanks(
      fullScaleScores
    );
  ...
  test('[INTERNAL] _RPSScompare: by rank majority', () => {
    ...
    const result: number = scorer._RPSScompare(
      rpssRank1,
      rpssRank2
    );

    const revert_result: number = scorer._RPSScompare(
      rpssRank2,
      rpssRank1
    );
  ...
  test('[INTERNAL] _genScoresFromSortedRankMatrix', () => {
    ...
    const result: Array < Score > = scorer._genScoresFromSortedRankMatrix(
      rm,
      4
    );
...
function genJudgeRank(
  judge: Judge, participant: Participant, score: number,
  rank: number
): JudgeRank {
  return {
    judgeId: judge.id,
...
function genJudgeWeightedNote(judge: Judge, participant: Participant, score: number) {
  return {
    judgeId: judge.id,
    participantId: participant.id,
    score: score
