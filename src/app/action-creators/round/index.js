...
export function getCreateRoundAction(tournamentId: string, round: Round): CreateRoundAction {
  return {
    type: CREATE_ROUND,
...
export function getDeleteRoundAction(tournamentId: string, deleteId: string): DeleteRoundAction {
  return {
    type: DELETE_ROUND,
...
export function getStartNextDanceAction(tournamentId: string): StartNextDanceAction {
  return {
