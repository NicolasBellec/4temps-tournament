...
export async function createRound(tournamentId: string, round: Round): Promise<Round> {
...
export async function startRound(tournamentId: string, roundId: string): Promise<mixed> {
...
export async function generateGroupsForRound(
  ...
  return apiPostRequest(`/api/round/${tournamentId}/generate-groups/${roundId}`)
}
...
export async function regenerateGroup(
  ...
  return apiPostRequest(`/api/round/${tournamentId}/regenerate/${roundId}/group/${groupId}`)
}

export async function settleDraw(tournamentId: string, roundScores: Array<Score>): Promise<mixed> {
