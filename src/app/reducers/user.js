...
function loginUser(state: UserReduxState, action: ReduxPackAction): UserReduxState {
...
function loginWithAccessKey(state: UserReduxState, action: ReduxPackAction): UserReduxState {
  const { payload } = action
  return handle(state, action, {
    success: () => ({
      id: payload.userId,
...
function logoutUser(state: UserReduxState, action: ReduxPackAction): UserReduxState {
  return handle(state, action, {
